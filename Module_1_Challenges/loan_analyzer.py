...
print(f"Total value of all loans: {loan_total}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
print(f"Avg loan amount: {loan_total/num_loans}")
...
# Print each variable.
future_value, remaining_months = loan.get('future_value'), loan.get('remaining_months')
...
if present_value >= price:
    print(f"Purchase this loan! It's net present value is: {present_value - price}")
else:
    print("This loan isn't worth it.")
...
def calc_present_value(future_value, remaining_months, annual_discount_rate):
    '''Returns calculated Present Value of annuity'''
    return future_value / (1 + annual_discount_rate/12) ** remaining_months

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
present_value = calc_present_value(new_loan.get('future_value'), new_loan.get('remaining_months'), 0.2)
